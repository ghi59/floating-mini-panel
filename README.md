...
Floating Mini Panel is available under the terms of the GPL-v2 or later license. See [https://github.com/ghi59/floating-min-panel/blob/master/LICENSE] for details.
